...
'15% of the City''s [ICON_PEACE] Faith converted into [ICON_CULTURE] Culture every turn. +1 [ICON_PEACE] Faith from Terrace Farms and Mountains. +1 [ICON_PEACE] Faith for every 3 Mountains within the workable tile.[NEWLINE]
...
SET Text = 'Unique {TXT_KEY_CIV_INCA_ADJECTIVE} replacement for the {TXT_KEY_BUILDING_TEMPLE}. {TXT_KEY_BUILDING_STEMPLES_DESC} converts small portion of [ICON_PEACE] Faith into [ICON_CULTURE] Culture, and increases [ICON_PEACE] Faith and [ICON_CULTURE] Culture of a city. Provides [ICON_PEACE] Faith from nearby Terrace Farms and Mountains.'
