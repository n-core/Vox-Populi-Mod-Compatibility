...
SELECT '+3 [ICON_PEACE] Faith. 5% of the City''s [ICON_PEACE] Faith converted into [ICON_GOLD] Gold and [ICON_CULTURE] Culture every turn. +1 [ICON_PEACE] Faith for every 2 Desert tiles within the workable plot. +1 [ICON_PEACE] Faith and [ICON_CULTURE] Culture from Kasbahs.[NEWLINE]
...
'It also greatly boosts the value of Trade Routes that target the City which possess {TXT_KEY_BUILDING_RIAD_DESC}. Additional [ICON_PEACE] Faith and [ICON_CULTURE] Culture bonus from Kasbahs.'
