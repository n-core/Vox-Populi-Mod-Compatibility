...
SELECT '+3 [ICON_PEACE] Faith. 5% of the City''s [ICON_PEACE] Faith converted into [ICON_GOLD] Gold and [ICON_CULTURE] Culture every turn. +1 [ICON_PEACE] Faith for every 2 Desert tiles worked by the City. +1 [ICON_PEACE] Faith and [ICON_CULTURE] Culture from Kasbahs.[NEWLINE]
