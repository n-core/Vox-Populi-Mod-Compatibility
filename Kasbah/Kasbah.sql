...
Happiness = 0, GreatPeopleRateModifier = 0, TradeRouteRecipientBonus = 2, TradeRouteTargetBonus = 1,
...
SELECT '+1 [ICON_GOLD] Gold and [ICON_CULTURE] Culture for every 20 [ICON_PEACE] Faith generated by the City. +1 [ICON_PEACE] Faith for every 2 Desert tiles worked by the City. +1 [ICON_PEACE] Faith and [ICON_CULTURE] Culture from Kasbahs.[NEWLINE]
[NEWLINE]Incoming [ICON_INTERNATIONAL_TRADE] Trade Routes generate +2 [ICON_GOLD] Gold for the City, and +1 [ICON_GOLD] Gold for [ICON_INTERNATIONAL_TRADE] Trade Route owner.[NEWLINE]
...
'In addition to the regular abilities of a {TXT_KEY_BUILDING_FORTRESS}, the {TXT_KEY_BUILDING_RIAD_DESC} generates [ICON_PEACE] Faith, and a small amount of those [ICON_PEACE] Faith are added into [ICON_GOLD] Gold and [ICON_CULTURE] Culture every turn. '||
'It also boosts the [ICON_GOLD] Gold value of [ICON_INTERNATIONAL_TRADE] Trade Routes. Provides additional [ICON_PEACE] Faith and [ICON_CULTURE] Culture bonus from Kasbahs.'
