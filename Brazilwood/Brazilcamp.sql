...
SELECT '+25% [ICON_GREAT_PEOPLE] Great People generation in this City. +1 [ICON_PEACE] Faith for every 6 [ICON_CITIZEN] Citizens in the City. +1 [ICON_CULTURE] Culture from Jungle. Increases the City''s resistance to conversion by 10%.[NEWLINE]
...
SELECT 'BUILDING_JCHURCH', 'RESOURCE_COCOA', 'YIELD_GOLD', 1 WHERE EXISTS (SELECT * FROM COMMUNITY WHERE Type='CBPMC_BRAZILWOOD_CAMP' AND Value= 1 ) UNION ALL
SELECT 'BUILDING_JCHURCH', 'RESOURCE_CLOVES', 'YIELD_FAITH', 1 WHERE EXISTS (SELECT * FROM COMMUNITY WHERE Type='CBPMC_BRAZILWOOD_CAMP' AND Value= 1 ) UNION ALL
SELECT 'BUILDING_JCHURCH', 'RESOURCE_CLOVES', 'YIELD_CULTURE', 1 WHERE EXISTS (SELECT * FROM COMMUNITY WHERE Type='CBPMC_BRAZILWOOD_CAMP' AND Value= 1 ) UNION ALL
SELECT 'BUILDING_JCHURCH', 'RESOURCE_PEPPER', 'YIELD_FAITH', 1 WHERE EXISTS (SELECT * FROM COMMUNITY WHERE Type='CBPMC_BRAZILWOOD_CAMP' AND Value= 1 ) UNION ALL
SELECT 'BUILDING_JCHURCH', 'RESOURCE_PEPPER', 'YIELD_GOLD', 1 WHERE EXISTS (SELECT * FROM COMMUNITY WHERE Type='CBPMC_BRAZILWOOD_CAMP' AND Value= 1 ) UNION ALL
SELECT 'BUILDING_JCHURCH', 'RESOURCE_NUTMEG', 'YIELD_PRODUCTION', 1 WHERE EXISTS (SELECT * FROM COMMUNITY WHERE Type='CBPMC_BRAZILWOOD_CAMP' AND Value= 1 ) UNION ALL
SELECT 'BUILDING_JCHURCH', 'RESOURCE_NUTMEG', 'YIELD_CULTURE', 1 WHERE EXISTS (SELECT * FROM COMMUNITY WHERE Type='CBPMC_BRAZILWOOD_CAMP' AND Value= 1 );
